...
public class NormalEnemy : Enemy {
    ...
    private int getRandomSeedByTurn() => getEnemyID() + GameController.Instance.getState().turnCount;
    ...
    private void addEasySkill(int index) {
        ...
        switch (index) {
            ...
            case 8:
                ...
                skillList.Add(EnemyHPBuff.Create(() => GameController.Instance.getState().turnCount % 3 == 0, hpBuff, getTarget2, 1, skillTrans));
                break;
            case 9:
