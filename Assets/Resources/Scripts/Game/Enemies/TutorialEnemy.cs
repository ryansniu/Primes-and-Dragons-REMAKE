...
public class TutorialEnemy : Enemy {
    ...
    protected override void addAllSkills() {
        ...
        EnemyBoardSkill test = EnemyBoardSkill.MarkIfSkill(() => GameController.Instance.getState().turnCount % 2 == 0, isEven, 0.1f, skillTrans);
        test.addRmvSkill(0.03f);
        skillList.Add(test);

        Func<Orb, bool> isOdd = (Orb o) => o.isOdd();
        EnemyBoardSkill test2 = EnemyBoardSkill.MarkIfSkill(() => GameController.Instance.getState().turnCount % 3 == 1, isOdd, 0.1f, skillTrans, 1);
        test2.addIncSkill(0.03f, (Orb o) => -1);
        skillList.Add(test2);

        Func<Orb, bool> rowCon = (Orb o) => o.getGridPos().x % 2 == 1;
        EnemyBoardSkill test3 = EnemyBoardSkill.MarkIfSkill(() => GameController.Instance.getState().turnCount % 3 == 2, rowCon, 0.1f, skillTrans);
