...
public class MiniBossData {
    ...
    public static IEnumerator getAttack(Enemy e, Player p, Board b) {
    ...
    public static IEnumerator getTakeDMG(Enemy e, int dmg, Player p, Board b) {
        switch (e.currState.number) {
            // Floor 15
    ...
    private static IEnumerator Attack16(Enemy e, Player p, Board b) {
        yield return null;
    }
    private static IEnumerator TakeDMG16(Enemy e, int dmg, Player p, Board b) {
        yield return null;
    }
}